//08.02 overload operators as member functions
//main adition is the same as in 08.01: Money ourAmount = yourAmount + myAmount;
//the difference is in + definition, line 64- header sand line 68
#include <iostream>
#include <cstdlib>
#include <cmath>
#include <conio.h>
...
public:
    ...
    void output( ) const;
    const Money operator +(const Money& amount2) const;//1- argument overload opersator as a member functionm
...
{
    int allCents1 = cents + dollars*100;// private data ; this line is different from 08.01 !!!!
...
const Money Money::operator -(const Money& secondOperand) const
{
    int allCents1 = cents + dollars*100;//you  get cents and dollars from input function
