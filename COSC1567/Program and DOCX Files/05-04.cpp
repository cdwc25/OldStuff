//Original 05-4.cpp has been modified
...
int main( )
{
    ...
    inputData(production, NUMBER_OF_PLANTS);//enters data to array production
    scale(production, NUMBER_OF_PLANTS);//scaling the array production
...
void scale(int a[], int size)
{
    for (int index = 0; index < size; index++)
        a[index] = roundmy(a[index]/1000.0);
}
...

{
                ...
                plantNumber <= lastPlantNumber; plantNumber++)
    {
		...
		//printAsterisks(asteriskCount[plantNumber]);
