...
package net.mcreator.gluon.world.dimension;
...
import net.mcreator.gluon.item.EmeraldItem;
...
public class EmeraldDimension extends GluonElements.ModElement {
	@ObjectHolder("gluon:emerald")
	public static final ModDimension dimension = null;
	@ObjectHolder("gluon:emerald_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public EmeraldDimension(GluonElements instance) {
		super(instance, 9);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("emerald"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("gluon:emerald")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("gluon:emerald"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("gluon:emerald"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("badlands")),};
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new CustomPortalBlock());
		elements.items.add(() -> new EmeraldItem().setRegistryName("emerald"));
	}
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("emerald_portal");
		}
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = EmeraldDimension.CustomPortalBlock.createPatternHelper(entity.world, new BlockPos(pos));
	...
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "emerald_portal",
	...
	public static class TeleporterDimensionMod extends Teleporter {
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = EmeraldDimension.CustomPortalBlock.createPatternHelper(this.world, blockpos);
